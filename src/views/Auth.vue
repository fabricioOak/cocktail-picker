    ...
    <div class="max-w-5xl mx-auto">
      <div class="flex flex-col items-center md:flex-row">
        <div class="w-full space-y-5 md:w-3/5 md:pr-16">
          <p class="font-medium text-pink-500 uppercase">Building Businesses</p>
          <h2
        ...
        <div class="w-full mt-16 md:mt-0 md:w-2/5">
          ...
          >
            ...
            <input
              type="text"
              name="email"
              class="block w-full px-4 py-3 mb-4 border-2 border-transparent border-gray-200 rounded-lg focus:ring focus:ring-pink-500 focus:outline-none"
            ...
            <div class="block">
              <button
                class="w-full px-3 py-4 font-medium text-white bg-pink-500 rounded-lg"
              >
                Log Me In
              </button>
            </div>
